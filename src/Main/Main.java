...
import Usecases.AddBus2usecase;
import Usecases.AdminLoginusecase;
import Usecases.BookTicketbNameusecase;
import Usecases.CancelTicketbNameusecase;
import Usecases.CusLoginusecase;
import Usecases.CusSignUp2usecase;
import Usecases.UpdateStatususecase;
import bus.custom.ConsoleColors;
import Usecases.ViewAllTicketusecase;
...
//		}
	...
	static void adminChoice(int choice) {
			...
			switch(choice) {
				...
				break;
				case 3 : {
					ViewAllTicketusecase.viewAllTicket();
					adminMethods();
				}
				break;
